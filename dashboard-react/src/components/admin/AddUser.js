...
function AddUser() {
    ...
    const apiCall = async (email, firstName, lastName, password, campusName, phoneNumber) => {
            ...
            <Col lg={10}>
                ...
                <Row>
                    ...
                    <Col lg={8} style={{ marginTop: '5%' }}>
                        <h4 style={{ marginTop: '5%', textAlign: "center" }}> Onboard a New Campus Security Officer </h4>
                        <Form onSubmit={submitHandler}>
                            ...
                            <Form.Label style={{ marginTop: '2%' }}>Phone Number</Form.Label>
                            <Form.Control required type="phoneNumber" placeholder="Phone Number" name='phoneNumber' />
                            <Form.Label style={{ marginTop: '2%' }}>Campus Name</Form.Label>
                            <Form.Control required type="campusName" placeholder="Campus Name" name='campusName' />
