                        ...
                        <div class="dropdown-menu dropdown-menu-right notification">
                            ...
                            <ul class="noti-body">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="images/user/avatar-1.jpg" alt="Generic placeholder image"></img>
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="images/user/avatar-2.jpg" alt="Generic placeholder image"></img>
                                        <div class="media-body">
                                ...
                                <li class="notification">
                                    <div class="media">
                                        <img class="img-radius" src="images/user/avatar-3.jpg" alt="Generic placeholder image"></img>
                                        <div class="media-body">
                ...
                <li>
                    <div class="dropdown drp-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right profile-notification">
                            <div class="pro-head">
                                <img src="images/user/avatar-1.jpg" class="img-radius" alt="User-Profile-Image"></img>
                                <span>{sessionStorage.getItem("userName")}</span>
                                <a href="#" class="dud-logout" title="Logout" onClick={logout}>
