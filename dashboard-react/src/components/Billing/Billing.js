                                    ...
                                    <div class="card card-event">
                                        <div class="card-block">
                                            <div class="row align-items-center justify-content-center">
                                                ...
                                                <div class="col-auto">
                                                    <label class="label theme-bg2 text-white f-14 f-w-400 float-right">$ 2500</label>
                                                </div>
                                            </div>
                                            <h2 class="mt-3 f-w-300"><sub class="text-muted f-14">Premium Plus Subscription Plan</sub></h2>
                                            <h6 class="text-muted mt-4 mb-0">Statement is generated first of every month </h6>
