...
function DataManagement() {
    ...
    useEffect(() => {
        ...
        const response = await axios.get("http://localhost:5000/building/getList");
    ...
    const handleSubmit = (event) => {
        ...
        axios.get('http://localhost:5000/videoData', {
          params: {
            startDate: startDate,
            endDate: endDate,
            cameraId: cameraId,
    ...
    return (<>
        ...
        <Row>
            ...
            <Row>
                <Col>
                <Form.Label style={{ marginTop: '5%' }}>Please select the start date:</Form.Label>
                <Form.Control
                    type="date"
                    name="startDate"
                    value={startDate}
                ...
                <Col>
                <Form.Label style={{ marginTop: '5%' }}>Please select the end date:</Form.Label>
                <Form.Control
                    type="date"
                    name="endDate"
                    value={endDate}
                ...
                <Col>
                <Form.Label style={{ marginTop: '5%' }}>Please enter the Camera ID you want feed from</Form.Label>
                <Form.Control
                    type="text"
                    name="description"
                ...
                <Col>
                <Form.Label style={{ marginTop: '5%' }}>Please select the Building Name</Form.Label>
                <Form.Control 
                as="select" 
                name="location"
                value={buildingName}
